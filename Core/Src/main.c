...
#include "stm32c0xx_hal.h"   // Adjust based on your STM32 family
extern UART_HandleTypeDef huart1; // or whichever UART you're using

int _write(int file, char *ptr, int len) {
    (void)file;  // File is not used, remove warning
...
int main(void)
{
  ...
  DBG_PRINT("Starting DeckCtrl firmware...\n");

  // Enable clock for GPIOA and C
...
static void MX_I2C1_Init(void)
{
  ...
  */
  ...
  I2C_InitStruct.OwnAddress1 = 132;
  ...
  LL_I2C_SetOwnAddress2(I2C1, I2C_ADDR_RESET, LL_I2C_OWNADDRESS1_7BIT);
